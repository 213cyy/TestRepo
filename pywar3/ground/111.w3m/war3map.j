...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'Hpal', - 448.7, - 740.6, 220.953)
    set u=CreateUnit(p, 'hpea', - 250.2, - 677.0, 313.515)
    set u=CreateUnit(p, 'hpea', - 138.8, 223.9, 1.659)
endfunction
