...
if __name__ == "__main__":
    ...
    from units.cube.conf import *
    from units.unit_default import *


class UnitCube(UnitDefault):
    unit_class_id = "cube"
    ...
    def update(self, frametime) -> None:
        ...
        self.position[2] = self.pos_origin_z + 100*np.sin(self.animate_time)+200
...
class CubeRenderEngine:
    ...
    def create_agent(self, player_id, position, eulers, color):
        # entity
        agent = UnitCube(self, player_id, position, eulers, color)
